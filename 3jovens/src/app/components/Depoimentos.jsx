...
const testimonials = [
    {
      ...
      image: "./img.png", // Imagem do cliente, mostrando que ele confiou na empresa
    ...
    },
    {
      ...
      image: "./img.png", // Imagem da cliente, indicando confiança na empresa
    ...
    },
    {
      ...
      image: "./img.png", // Imagem da cliente, representando confiança nos serviços da empresa
    ...
    },
    {
      ...
      image: "./img.png", // Imagem do cliente, reforçando a satisfação com a 3 Jovens
    ...
    },
    {
      ...
      image: "./img.png", // Imagem do cliente, evidenciando a credibilidade da empresa
    ...
    style={{
      ...
      <div className="mt-8 w-full max-w-6xl p-8">
        <Swiper
          ...
          autoplay={{
            delay: 4000, // Troca automática a cada 4 segundos (ajustado para milissegundos)
